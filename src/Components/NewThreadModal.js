   ...
   // console.log(event.target.ControlTextarea1.value);
    ...
    if (this.formValidate(event.target.ControlTextarea1.value)) {
      ...
      if (
        ...
        this.props.submitDSOThread(newMessage, this.state.ownerIdsfromTagsRetrieved);
        this.props.hideModal();
     ...
     // console.log("Calling getDPNSDocsforNewThreadModal");
            ...
            <Form noValidate onSubmit={this.handleSubmitClick}>
              <Form.Group className="mb-3" controlId="ControlTextarea1">
                ...
                <Form.Control
                  ...
                  required
                  isInvalid={
                    this.state.tooLongError || this.state.tooManyTagsError
