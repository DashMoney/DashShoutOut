...
//Puts in back to an array
  ...
  formValidate = (messageText) => {
    ...
    if (valid && !this.state.tooManyTagsError && !this.state.tooFewTagsError) { //Put tag error here
      this.setState({
...
*/
        ...
        this.props.submitDSODocument(newMessage, this.state.ownerIdsfromTagsRetrieved);
        this.props.hideModal();
            ...
            >
              ...
              >
                ...
                <Form.Control
                  ...
                  required
                  isInvalid={this.state.tooLongError || this.state.tooManyTagsError | this.state.tooFewTagsError || (this.state.taggedArray !== 0 &&
...
{this.state.retrievedNameLabelArray.length < 1 ? (
                  ...
                  <div><b>Dash Names: </b>{labelsToDisplay}</div>
                  </>
                )}

{this.state.retrievedNameLabelArray.length < 1 && this.state.taggedArray.length > 0 ? (
                  <div><b>Dash Names: </b>(There are no matching Dash Names)</div>
                ) : (
                  <>
                  </>
                )}
