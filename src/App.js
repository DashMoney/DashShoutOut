...
class App extends React.Component {
            ...
            LocalForage.getItem(walletIdToTry)
              .then((val) => {
                ...
                if (
                  ...
                  //This is if the LocalForage return fails to validate
  ...
  getInitialForyouFromOthersTags = (theIdentity) => {
    ...
    getTagsFromtoUserIdYourOwnerId()
      ...
      .catch((e) =>
        console.error("Something went wrongInitialMsgsfrom Tags:\n", e)
      )
      .finally(() => client.disconnect());
  };
  ...
  getInitialMsgsFromTags = (idsOfMsgsFromTags) => {
    ...
    getDocuments()
      ...
      .catch((e) =>
        console.error(
          "Something went wrong in InitialForyouFromOthersMsgs:\n",
          e
        )
      )
      .finally(() => client.disconnect());
  ...
  getInitialMsgsFromTagsNames = (docArray) => {
    ...
    getNameDocuments()
      ...
      .catch((e) => {
        console.error(
          "Something went wrong getting InitialForYouTagsNames:\n",
          e
        );
      })
      .finally(() => client.disconnect());
